...
for line in readlines(input_data)
 ...
 arthiritis_limit                 = getValues(line[120],1)       # LMTJOIN3 - Limited Because of Joint Symptoms
 arthiritis_affect_work           = getValues(line[121],1)       # ARTHDIS2 - Does Arthritis Affect Whether You Work
 arthiritis_activity              = getValues(line[122],1)       # ARTHSOCL - Social Activities Limited Because of Joint Symptoms
 ...
 write(output_file, "$state,$marital_status,$interview_month,$gender,$employment_status,$income_lvl,$told_arthritis,$arthiritis_limit, $arthiritis_affect_work,$arthiritis_activity,$joint_pain_lvl,$past_30day_exercise\n")
    ...
    df = CSV.read("/Users/louishuang/Desktop/project1/ME_output.csv")
        ...
        names!(df, [:state,:marital_status,:interview_month,:gender,:employment_status,:income_lvl,:told_arthritis,:arthiritis_limit,:arthiritis_affect_work,:arthiritis_activity,:joint_pain_lvl,:past_30day_exercise])
         ...
         CSV.write("/Users/louishuang/Desktop/project1/ME_output.csv", df)
...
######################################################################
###### Set raw values  readable  catagory values                     #
######                                                               #
######################################################################
...
df |> @vlplot(:bar, title = "Employment Status vs Joint Pain Level", x = {field = :employment_status, axis = {title = "Employment Status", labelAngle = 300}}, 
...
df |> @vlplot(:bar, title = "Gender Vs Arthiritis at Work", labelAngle = 45, 
    x = {field=:arthiritis_affect_work, axis = { title="Arthiritis Affect Work", labelAngle=300}},
    y = :"count()",
